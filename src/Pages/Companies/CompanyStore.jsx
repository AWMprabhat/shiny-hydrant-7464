    ...
    <>
      ...
      <Box width="90%" margin="auto">
        <Flex justifyContent="space-around" gap="5px">
              ...
              jobs.map((e, i) => (
                ...
                >
                  ...
                  <Flex justifyContent="space-between">
                    ...
                    <Box padding="16px" margin="2rem" color="white">
                      <ApplyAlert />
                    </Box>
                  </Flex>
                  {/* 2 */}
          ...
          {/* start add box */}
          <Box height="auto" width="28%" marginTop="5rem" bgColor="thunder">
            <Flex
            ...
            <Box marginTop="10rem" border="1px solid black" borderRadius="40px">
              ...
              <Flex width="100%" marginTop="1rem" justifyContent="space-evenly">
                <img
                  width="40px"
                  height="40px"
